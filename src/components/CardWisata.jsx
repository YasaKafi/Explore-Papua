  ...
  return (
    <div className="relative mx-auto my-8 h-52 w-2/6 rounded-xl overflow-hidden shadow-lg">
      ...
      <p className="absolute text-xs text-white bottom-5 mx-5">
        Lorentz National Park adalah taman nasional terbesar di Indonesia dan
        salah satu yang terbesar di dunia. Taman nasional ini terletak di Papua
        dan memiliki luas lebih dari 2,4 juta hektar.
      </p>
    </div>
  );
}
